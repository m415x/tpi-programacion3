...
public class OrderController {
    ...
    /**
     * Mapea a: POST /orders/{id}/items?productId=X&qty=Y Añade un nuevo producto al pedido actual
     * de forma controlada.
     */
    ...
    /**
     * Mapea a: PUT /orders/{id}/items/{productId}?qty=Y Actualiza la cantidad de un ítem existente
     * dentro de la orden.
     */
    ...
    /**
     * Mapea a: GET /orders/{id}/items/count Devuelve la sumatoria total de ítems en el pedido
     * actual.
     */
