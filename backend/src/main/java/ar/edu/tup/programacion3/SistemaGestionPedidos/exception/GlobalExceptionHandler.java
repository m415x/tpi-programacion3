...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleConstraintViolation(ConstraintViolationException ex, HttpServletRequest request) {
        ...
        ErrorDTO errorResponse =
                ErrorDTO.of(HttpStatus.BAD_REQUEST.value(), "Error de validación", details, request.getRequestURI());
	...
	public ResponseEntity<ErrorDTO> handleNumberFormat(NumberFormatException ex, HttpServletRequest request) {
	...
	@ExceptionHandler({UnsupportedOperationException.class, ConsoleMenuRunner.OperationCancelledException.class})
	public ResponseEntity<ErrorDTO> handleIllegalOperations(Exception ex, HttpServletRequest request) {
		ErrorDTO errorResponse = ErrorDTO.simpleOf(
